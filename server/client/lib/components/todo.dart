...
class _todoState extends State<todo> {
                         ...
                         child: Card(
                           ...
                           child: ListTile(
                              onTap: () {
                                ...
                                _showDescription('${items![index]['title']}','${items![index]['description']}');
                              },
                              onLongPress:() {
                                print('${items![index]['_id']}');
                                print('${items![index]['title']}');
                                ...
                                _todoDesc.text = '${items![index]['description']}';
                                _displayTextEditDialog('${items![index]['_id']}', '${items![index]['title']}', '${items![index]['description']}');},
                             leading: Icon(Icons.task),
                             title: Text('${items![index]['title']}'),
                             trailing: IconButton(
                              icon: Icon(Icons.delete),
                              onPressed: () => deleteItem('${items![index]['_id']}'),
                             ),
  ...
  Future<void> _displayTextEditDialog(String id, String title, String description) async {
    return showDialog(
        context: context,
        builder: (context) {
          return AlertDialog(
