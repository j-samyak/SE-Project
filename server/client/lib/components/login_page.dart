...
import 'package:login_signup/components/config.dart';
  ...
  void loginUser() async{
    if(emailController.text.isNotEmpty && passwordController.text.isNotEmpty){
      ...
      if(jsonResponse['status']){
        ...
        Navigator.push(context, MaterialPageRoute(builder: (context)=>todo(token: myToken)));
      }else{
        _handleLoginUser();
      }
    }
                    ...
                    child: Form(
                      ...
                      child: Column(
                        children: [
                          ...
                          CustomFormButton(innerText: 'Login', onPressed: loginUser,),
